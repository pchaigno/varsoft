...
TestImportNewData::TestImportNewData() {
    ...
    QString file = "C:/Users/Eric/Downloads/table.csv";
    QString data;
    ...
    TestImportNewData::newFile =  TestImportNewData::stockName+"_test.txt";
    ...
    flux.setCodec("UTF-8");
    QDateTime firstDate = QDateTime::fromString(TestImportNewData::firstDate,"yyyy-MM-dd");
    QDateTime lastDate = QDateTime::fromString(TestImportNewData::lastDate,"yyyy-MM-dd");
...
void TestImportNewData::testDates() {
    ...
    qDebug() << rowData[0];
    //QCOMPARE(TestImportNewData::firstDate, rowData[0]);

    //last date
    rowData = rowOfData.at(rowOfData.size()).split(",");
    qDebug() << rowData[0];
    //QCOMPARE(TestImportNewData::lastDate, rowData[0]);
}
