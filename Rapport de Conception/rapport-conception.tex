...
Il est intéressant pour les financiers de quantifier les risques de pertes, afin prévoir des montants adéquats pour couvrir ces pertes éventuelles.
...
% TODO Remove PDF class from diagram.
\begin{figure}
  	\center
